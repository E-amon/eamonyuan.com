...
export default function PortfolioHome() {
  const projects = [
    ...
    },
    {
      ...
      description:
        "Research-focused trading system using historical market data, risk controls, backtesting, and strategy evaluation. Proprietary logic is kept private.",
        ...
        >
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <a
                href="mailto:contact@eamonyuan.com"
          ...
          <div className="rounded-3xl border border-slate-800 bg-slate-900/70 p-6 shadow-2xl shadow-black/30">
            ...
            <div className="mt-5 space-y-4 text-sm text-slate-300">
              ...
              <div className="rounded-2xl bg-slate-800/80 p-4">
                ...
                <p className="mt-1">Targeting data science, quant research, analytics, and software engineering roles.</p>
              </div>
            </div>
          </div>
        </motion.div>
      ...
      <section className="mx-auto max-w-6xl px-6 pb-20">
        <div className="rounded-3xl border border-slate-800 bg-slate-900/70 p-8">
          <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h2 className="text-2xl font-bold text-white">Resume & Contact</h2>
              <p className="mt-2 text-slate-300">
                This website is under active development. More project details, case studies, and resume links will be added soon.
              </p>
            </div>
            <div className="flex flex-wrap gap-3">
              <a
                ...
                className="inline-flex items-center gap-2 rounded-2xl border border-slate-700 px-5 py-3 text-sm font-semibold text-slate-100 transition hover:border-cyan-300 hover:text-cyan-300"
              >
                <FileText size={18} /> Resume Coming Soon
              </a>
            </div>
          </div>
        </div>
